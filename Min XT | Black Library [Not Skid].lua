--[[if game.CoreGui:FindFirstChild("Min Gaming") then
    game.CoreGui:FindFirstChild("Min Gaming"):Destroy()
end
...
local Dev = ui:AddTab("Info","rbxassetid://6026568198")
local Farm = ui:AddTab("Main","rbxassetid://13075651575")
local Auto = ui:AddTab("Quest","rbxassetid://13075622619")
local Stats = ui:AddTab("Stats","rbxassetid://7040410130")
local Rac = ui:AddTab("Race V4","rbxassetid://11162889532")
local Playy = ui:AddTab("Player","rbxassetid://7251993295")
local Raid = ui:AddTab("Raid","rbxassetid://11155986081")
local TP = ui:AddTab("Teleprot","rbxassetid://11155851001")
