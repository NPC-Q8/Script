...
function Notif.New(text, timee)
    ...
    image_button.Image = "rbxassetid://13717478897"
...
UIGradient.Color = ColorSequence.new{
	...
	ColorSequenceKeypoint.new(1, Color3.fromRGB(0, 239, 5))
}
...
function Update:Window(text,logo,keybind)
    ...
    Main.BackgroundColor3 = Color3.fromRGB(0, 0, 0, 0)
    ...
    BtnStroke.Color = Color3.fromRGB(0, 239, 5)
    ...
    Ping.Text = "Blox Fruit | https://discord.gg/Dg5nr8CrVV         [RightControl]                             "
...
local Logo = Instance.new("ImageLabel")
	...
	Logo.Image = "rbxassetid://17314410864"
    ...
    ScrollTab.BackgroundColor3 = Color3.fromRGB(0, 239, 5)
    ...
    function uitab:AddTab(text,img)
        ...
        NotificationHold.BackgroundColor3 = Color3.new(0, 239, 5)
        ...
        NotificationTitle.TextColor3 = Color3.fromRGB(0, 239, 5)
    ...
    function main:AddButton(text, callback)
        ...
        Button.BackgroundColor3 = Color3.fromRGB(0, 239, 5)
    ...
    function main:AddToggle(TogInfo ,default, callback)
        ...
        UIStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
        UIStroke.Color = Color3.fromRGB(0, 239, 5)
    ...
    function main:AddDropdown(text,option,callback)
        ...
        DropScroll.BackgroundColor3 = Color3.fromRGB(0, 239, 5)
        ...
        DropButton.BackgroundColor3 = Color3.fromRGB(0, 239, 5)
    ...
    function main:AddSlider(text, min, max, start, callback)
        ...
        SliderFrame.BackgroundColor3 = Color3.fromRGB(0, 239, 5)
        ...
        SliderCount.BackgroundColor3 = Color3.fromRGB(0, 239, 5)
        ...
        SliderStroke.Color = Color3.fromRGB(0, 239, 5)
    ...
    function main:AddTextbox(text,disappear,callback)
        ...
        Textbox.BackgroundColor3 = Color3.new(0, 239, 5)
    ...
    function main:AddTextbox(text,disappear,callback)
        ...
        TextboxLabel.Name = "TextboxLabel"
        TextboxLabel.Parent = Textbox
        TextboxLabel.BackgroundColor3 = Color3.fromRGB(0, 239, 5)
        TextboxLabel.BackgroundTransparency = 1.000
        TextboxLabel.Position = UDim2.new(0, 15, 0, 0)
        TextboxLabel.Text = text
        TextboxLabel.Size = UDim2.new(0, 145, 0, 31)
        ...
        RealTextbox.Font = Enum.Font.GothamSemibold
        RealTextbox.Text = ""
        RealTextbox.TextColor3 = Color3.fromRGB(0, 239, 5)
        RealTextbox.TextSize = 11.000
        RealTextbox.TextTransparency = 0
    ...
    function main:AddSeperator(text)
        ...
        Sep1.BackgroundColor3 = Color3.new(0, 239, 5)
        ...
        Sep3.BackgroundColor3 = Color3.new(0, 239, 5)
    ...
    function main:AddLine()
        ...
        Line.Name = "Line"
        Line.Parent = Linee
        Line.BackgroundColor3 = Color3.new(0, 239, 5)
        Line.BorderSizePixel = 0
				...
				if ESPPlayer then
					if not isnil(v.Character.Head) and not v.Character.Head:FindFirstChild('NameEsp'..Number) then
						...
						if v.Team == game.Players.LocalPlayer.Team then
							...
							name.TextColor3 = Color3.new(140,18,222)
						end
					else
			...
			if v.Name == "Flower2" or v.Name == "Flower1" then
				if FlowerESP then 
					if not v:FindFirstChild('NameEsp'..Number) then
						...
						name.BackgroundTransparency = 1
						name.TextStrokeTransparency = 0.5
						name.TextColor3 = Color3.fromRGB(0, 239, 5)
...
local Main = Library:AddTab("Main Farm","4483345998")
local M = Library:AddTab("Item Quest","4483345998")
local Sea = Library:AddTab("Sea Even","4483345998")
local Ss = Library:AddTab("Stats","4483345998")
local RaceV4 = Library:AddTab("Race V4","4483345998")
local P = Library:AddTab("Player pvp","4483345998")
local R = Library:AddTab("Dungeon","4483345998")
local T = Library:AddTab("Teleport","4483345998")
local S = Library:AddTab("Shopee","4483345998")
local D = Library:AddTab("Fruit","4483345998")
...
local AttackList = {"Slow", "Normal", "fast", "Low", "Super", "Extra"}
    ...
    while wait(.1) do
        if _G.FastAttackDelay then
            pcall(function()
                ...
                elseif _G.FastAttackDelay == "Extra" then                                
...
Mirragecheck = Sea:AddLabel("")
Sea:AddToggle("Tween Mystic Island",_G.AutoMysticIsland,function(value)
        ...
        spawn(function()
            ...
            Sea:AddButton("Teleport Advanced Fruit Dealer", function()
                TweenNpc()
                end)
    ...
    Sea:AddToggle("Summon Mystic Island",_G.dao,function(state)
    if state then
        _G.dao = true
    else
        _G.dao = false
...
Sea:AddToggle("Tween Gear",_G.TweenMGear,function(value)
_G.TweenMGear = value
...
FrozenIsland = Sea:AddLabel("")

Sea:AddToggle("Auto Zone",_G.BiirTrax,function(state)
    if state then
        _G.BiirTrax = true
    else
        _G.BiirTrax = false
...
Kitsunecheck = Sea:AddLabel("check Kitsune")

spawn(function()
    pcall(function()
        while wait() do
            if game.Workspace._WorldOrigin.Locations:FindFirstChild('Kitsune Island') then
                Kitsunecheck:Set('✅:Kitsune spam')
            else
                Kitsunecheck:Set('❌:Kitsune Not Found')
            end
        end
    end)
end)

Sea:AddToggle("Tween To Kitsune Island",_G.AutoFKitsune,function(value)
    _G.AutoFKitsune = value
    StopTween(_G.AutoFKitsune)
    end)
    
    Sea:AddToggle("Esp Kitsune Island", false, function(value)
    ...
    Sea:AddToggle("Collect Azure Ambers",_G.AutoAzuerEmber,function(value)
...
M:AddToggle("Auto Enable Haki Legendary",false,function()
AutoHaki()
wait(0.5) 
local args = {
[1] = "activateColor",
...
S:AddButton("Buy Boat",function()
    ...
    S:AddButton("Buy Fishman Karate [ $750,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyFishmanKarate")
    end)
    
    S:AddButton("Buy Dragon Claw [ $1,500 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","1")
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","2")
    end)
    ...
    S:AddButton("Buy Death Step [ $2,500,000 5,000F ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep")
    end)
    
    S:AddButton("Buy Sharkman Karate [ $2,500,000 5,000F ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate",true)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate")
    end)
    
    S:AddButton("Buy Electric Claw [ $3,000,000 5,000F ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw")
    end)
    
    S:AddButton("Buy Dragon Talon [ $3,000,000 5,000F ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon")
    end)

    S:AddButton("Buy God Human [ $5,000,000 5,000F ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyGodhuman")
    end)
    
    S:AddButton("Buy Sanguine Art [ $5,000,000 5,000F ]",function()
    ...
    S:AddButton("Pole v.2 [ 5,000F ]",function()
    ...
    S:AddButton("Kabucha [ 1,500F ]",function()
...
S:AddButton("Reset Stats [2,500F ]", function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","1")
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","2")
end)

S:AddButton("Random Race [ 3,000F ]", function()
